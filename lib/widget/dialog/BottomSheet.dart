 ...
 * 自定义底部菜单
 */
class CyogaBottomSheet extends StatefulWidget {
  CyogaBottomSheet({Key key, this.list, this.onItemClickListener})
      : assert(list != null),
        super(key: key);
  final list;
  final OnItemClickListener onItemClickListener;
  @override
  _CyogaBottomSheetState createState() => _CyogaBottomSheetState();
}
typedef OnItemClickListener = void Function(int index);

class _CyogaBottomSheetState extends State<CyogaBottomSheet> {
